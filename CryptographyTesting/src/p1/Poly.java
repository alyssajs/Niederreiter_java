   ...
   */
    ...
    {  
       ...
       {              
          ...
          {   
             ...
             gfPoly factor = 
                   gfPoly.getModularInverse(denominator.coefficients[denominator.degree], 
                       irred);
             factor
                   = gfPoly.gf_multiply(factor, 
                         num.coefficients[num.degree], irred);
    ...
    public static Poly multiply(Poly polyOne, Poly polyTwo, gfPoly irredPoly)
    {
       ...
       for(int i = 0; i <= polyOne.degree; i++)
       {
          ...
          {
             resultCoeffs[i+j] = gfPoly.gf_add(resultCoeffs[i+j], 
                   gfPoly.gf_multiply(polyOne.coefficients[i], polyTwo.coefficients[j], irredPoly));
          }
       }
    ...
    public static Poly getQuotient(Poly numerator, Poly denominator, gfPoly fieldPoly)
    {
       ...
       {
             quotient.coefficients[numerator.degree - denominator.degree] = 
                   gfPoly.getModularInverse(denominator.coefficients[denominator.degree], 
                       fieldPoly);
             quotient.coefficients[numerator.degree - denominator.degree] 
                   = gfPoly.gf_multiply(quotient.coefficients[numerator.degree - denominator.degree], 
                         numerator.coefficients[numerator.degree], fieldPoly);
    ...
    */
    ...
    public static Poly add(Poly polyOne, Poly polyTwo)
    {
       ...
       {
          coeffs[addIndex] = gfPoly.gf_add(largerPoly.coefficients[addIndex], 
                otherPoly.coefficients[addIndex]);
       }
    ...
    static Poly calcSqrt(Poly poly, Poly mod, int extDegree, gfPoly fieldPoly)
    {
       ...
       {
          sqrtEven.coefficients[i] = gfPoly.calcSqrt(sqrtEven.coefficients[i],
                                               fieldPoly, extDegree);
       }
       ...
       {
          sqrtOdd.coefficients[i] = gfPoly.calcSqrt(sqrtOdd.coefficients[i],
                                               fieldPoly, extDegree);
       }
